...
--
-- Name: rentalppm; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE rentalppm WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'English_United States.1252' LC_CTYPE = 'English_United States.1252';


ALTER DATABASE rentalppm OWNER TO postgres;
