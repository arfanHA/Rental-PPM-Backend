...
class receiving_detail_sn(models.Model):
    ...
    first_serial_number = models.CharField(max_length=100, blank=True)
    new_serial_number = models.CharField(max_length=100, blank=True)
    receiving_detail_id = models.ForeignKey(receiving_detail, on_delete=models.DO_NOTHING, blank=True, related_name='RDISN')
